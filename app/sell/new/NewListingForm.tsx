...
// $79, Skill at $109, MCP Server at $149, Loop at $149, Full Agent
// Setup at $999+ — walks a creator up the ladder as their scope +
// price grows.
const types = [
  ...
  { key: 'skill', title: 'Skill', price: '$9 – $109+', desc: 'Drop-in capability files.' },
  {
    ...
    title: 'MCP Server',
    price: '$29 – $149+',
    desc: 'Packaged tools + data sources for Claude / Cursor / any MCP host.',
  },
  {
    key: 'loop',
    title: 'Loop',
...
export default function NewListingForm({
  ...
  const [type, setType] = useState<'skill' | 'guide' | 'agent_setup' | 'prompt_pack' | 'loop' | 'mcp_server'>('skill')
