    ...
    >
      <div className="h-full flex flex-col p-6 sm:p-7">
        ...
        <div className="mt-auto pt-10 flex items-end justify-between">
          {/* Pre-launch: a "0.0 (0)" row reads as nobody-bought-this and
              quietly tanks new listings. Hide the rating entirely until
              there's at least one real review. Once a listing has ≥1
              review we show stars + the numeric rating, no count — the
              count is the part that hurts at low volume. */}
          {product.rating > 0 ? (
            <span
              className={
