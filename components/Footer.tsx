      ...
      <div className="max-w-page mx-auto px-6 lg:px-10 py-14">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-3">
            <p className="label-cap text-brand-emerald mb-4">Catalogue</p>
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/marketplace?type=agent-setup" className="hover:text-brand-emerald transition-colors">Agent Setups</Link></li>
              <li><Link href="/marketplace?type=skill" className="hover:text-brand-emerald transition-colors">Skills</Link></li>
              <li><Link href="/marketplace?type=guide" className="hover:text-brand-emerald transition-colors">Guides</Link></li>
              <li><Link href="/marketplace" className="hover:text-brand-emerald transition-colors">All of it</Link></li>
            </ul>
          </div>

          <div className="md:col-span-2">
            <p className="label-cap text-brand-emerald mb-4">Skillzy</p>
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/about" className="hover:text-brand-emerald transition-colors">About</Link></li>
              <li><Link href="/sell" className="hover:text-brand-emerald transition-colors">Sell</Link></li>
              <li><Link href="/contact" className="hover:text-brand-emerald transition-colors">Contact</Link></li>
            </ul>
          </div>

          <div className="md:col-span-2">
            <p className="label-cap text-brand-emerald mb-4">Fine print</p>
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/terms" className="hover:text-brand-emerald transition-colors">Terms</Link></li>
              <li><Link href="/privacy" className="hover:text-brand-emerald transition-colors">Privacy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-14 pt-6 border-t border-brand-hairline flex flex-col-reverse sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-brand-muted">
            <a href="https://x.com/skillzy" aria-label="X" className="hover:text-brand-emerald transition-colors">
            ...
            <a href="https://github.com/skillzy" aria-label="GitHub" className="hover:text-brand-emerald transition-colors">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <a href="mailto:hello@skillzy.com" aria-label="Email" className="hover:text-brand-emerald transition-colors">
