...
export const PLATFORM_CONTENT: PlatformContent[] = [
  ...
  P('Grok Bots', 'grok-bots', 'llm', 'Custom Grok bots — character and persona-driven agents built on xAI’s Grok, with real-time data and tool use.', 'Grok Bots let creators package a whole persona — the system prompt, tools, voice, and knowledge — as a drop-in agent someone else can spin up in seconds. This is where a lot of the interesting creator work is landing in 2026.', '5 minutes'),
