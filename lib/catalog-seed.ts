...
const SPECS: Spec[] = [
  ...
  // E-commerce
  { id: 'returns-and-wismo', type: 'Agent Setup', title: 'Returns + “where is my order”.', tagline: 'The two queries that eat your support inbox, automated end to end.', niche: 'E-commerce', creator: C.brewline, platforms: ['Claude', 'n8n', 'Zapier'], price: '$159', rating: 4.7, ratingCount: 39, description: ['WISMO and returns are 70% of e-com tickets. This handles both, escalates the rest.'], whatYouGet: ['7 SKILL.md files', 'Returns policy logic', 'Carrier tracking lookups', 'Shopify + Gorgias connectors'] },
  ...
  { id: 'free-daily-standup', type: 'Skill', title: 'Daily standup summary.', tagline: 'Bullet points in, a Slack-ready standup out.', niche: 'Agencies', creator: C.northbound, platforms: ['Claude', 'OpenClaw'], price: '$12', rating: 4.7, ratingCount: 28, description: ['Paste your rough notes, get a clean standup your team will actually read.'], whatYouGet: ['1 SKILL.md', 'Slack-format output', 'Tone config'] },
  { id: 'free-invoice-parser', type: 'Skill', title: 'Invoice line-item parser.', tagline: 'Messy invoice text in. Structured line items out.', niche: 'Bookkeepers', creator: C.benchnote, platforms: ['Claude', 'n8n'], price: '$14', rating: 4.6, ratingCount: 58, description: ['Extracts structured data from messy invoice text — a solid first bookkeeping skill.'], whatYouGet: ['1 SKILL.md', 'Output schema', 'Worked examples'] },
  { id: 'free-review-responder-starter', type: 'Skill', title: 'Review responder — starter.', tagline: 'A focused review responder — one tone, one channel.', niche: 'E-commerce', creator: C.brewline, platforms: ['Claude'], price: '$9', rating: 4.5, ratingCount: 36, description: ['A focused starter: one tone, one channel, genuinely useful.'], whatYouGet: ['1 SKILL.md', 'Brand-voice config', 'Examples'] },
  { id: 'free-first-agent-guide', type: 'Guide', title: 'Your first AI agent in 20 minutes.', tagline: 'Non-dev walkthrough: wire Claude into Telegram.', niche: 'Education', creator: C.chalkline, platforms: ['Claude'], price: '$19', rating: 4.8, ratingCount: 14, description: ['A no-jargon walkthrough that gets a non-developer from zero to a working agent in one sitting.'], whatYouGet: ['Step-by-step guide', 'Copy-paste starter', 'Troubleshooting notes'] },
  { id: 'free-skillmd-cheatsheet', type: 'Guide', title: 'The SKILL.md cheat sheet.', tagline: 'One page. Every field. The reference.', niche: 'Education', creator: C.chalkline, platforms: ['Claude', 'OpenClaw'], price: '$9', rating: 4.7, ratingCount: 12, description: ['A single-page reference for the SKILL.md format. Print it, pin it, ship faster.'], whatYouGet: ['1-page PDF', 'Field-by-field reference', 'Common mistakes'] },
]
