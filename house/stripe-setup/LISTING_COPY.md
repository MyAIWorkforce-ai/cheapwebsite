...
- 6 SKILL.md files covering account setup, products + prices, payment pages, webhooks, tax + refunds, and customer portal + reporting
...
Upload these from the `house/stripe-setup/` folder (in order):

1. `README.md`
2. `SETUP.md`
3. `MASTER_PROMPT.md`
4. `skills/01-account-setup.md`
5. `skills/02-products-prices.md`
6. `skills/03-payment-pages.md`
7. `skills/04-webhooks-fulfillment.md`
8. `skills/05-tax-refunds.md`
9. `skills/06-portal-reporting.md`

(Don't upload this LISTING_COPY.md — internal only.)

## Suggested handle / creator

Same approach as Site Builder — recommend posting under `@skillzy`
house creator while establishing the catalogue. Switch to personal
handles once real creators come on.
